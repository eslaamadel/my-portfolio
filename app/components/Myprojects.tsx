      ...
      >
        ...
        <div className="grid edk:grid-cols-3 dk:grid-cols-3 sdk:grid-cols-2 tb:grid-cols-2 mb:grid-cols-1 gap-10">
          <div
            ...
            className="px-7 py-[68px] h-[550px] mb:h-[450px] dark:bg-Primary-950 bg-Primary-100 rounded-2xl relative overflow-hidden"
          >
          ...
          <div
            data-aos="fade-up"
            data-aos-duration="700"
            className="px-7 py-[68px] h-[550px] mb:h-[450px] dark:bg-Primary-950 bg-Primary-100 rounded-2xl relatives overflow-hidden"
          >
            <div className="flex flex-col gap-6 ">
              <div className="flex flex-col gap-2 z-10">
                <h2 className="text-h-4 dark:text-netu-50 text-netu-950 font-bold">
