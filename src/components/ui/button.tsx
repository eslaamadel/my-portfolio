...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 dark:focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-accent-default text-white shadow-sm hover:bg-accent-Hover focus:bg-accent-Hover active:bg-Primary-800",
        destructive:
          "dark:bg-red-500 text-slate-50 shadow-sm hover:bg-red-500/90 bg-red-900",
        outline:
          "border border-slate-200 bg-white shadow-sm hover:bg-slate-100 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50",
        secondary:
          "bg-Primary-900 hover:bg-Primary-950/90 text-white shadow-sm dark:hover:bg-Primary-800/50 dark:focus:bg-Primary-800/50 focus:bg-Primary-950/95 dark:active:bg-Primary-800/40 active:bg-Primary-950",
        ghost:
